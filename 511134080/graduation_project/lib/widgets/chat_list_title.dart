...
class EventListTile extends StatelessWidget {
  ...
  AlertDialog _alertDialog(BuildContext context, Chat chat) => AlertDialog(
        title: Center(
  ...
  Widget _alertDialogTitle(Chat chat, BuildContext context) => Row(
  ...
  Widget _alertDialogContent(Chat chat, BuildContext context) => Column(
  ...
  ListTile _editOption(BuildContext context) => ListTile(
        leading: const Icon(
          Icons.edit,
          color: Colors.cyan,
          size: 24,
  ...
  ListTile _deleteOption(BuildContext context) => ListTile(
        leading: const Icon(
          Icons.delete,
